...
\begin{itemize}
    \item Analyse microstructures of upper gastrointestinal (GI) sphincters and develop computational models using novel imaging techniques and deep learning to improve understanding of GI disorders and benefit in silico experiments.
\end{itemize}
