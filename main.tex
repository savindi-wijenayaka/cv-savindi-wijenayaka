...
\begin{itemize}
    \item Analysing microstructures of Gastrointestinal sphincters and creating computational models with the aid of \textbf{deep learning} to benefit in silico experiments in the future.
\end{itemize}
